...
void EnableLedPort(uint8_t bits)
{
	...
	if(mdLed.LedInfo[bits].UseFlage == 1)
	{
		...
		GPIO_Init(mdLed.LedInfo[bits].GPIO_Port,&GPIO_Init_Structure);  
	}
}
...
void SysLedParmInit()
{
	...
	mdLed.LedInfo[0].GPIO_Port = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800));
	mdLed.LedInfo[0].GPIO_Pin = ((uint16_t)0x0100);
