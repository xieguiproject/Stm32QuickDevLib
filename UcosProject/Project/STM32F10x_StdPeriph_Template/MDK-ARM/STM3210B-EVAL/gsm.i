...
typedef struct tagGsmComInfo_s
{
	uint8_t RecvMessage[1024];					 
	uint8_t SendMessage[512];					 
	uint8_t RecvCount;															 
	uint8_t SendCount;															 
	uint8_t WorkFlage;															 
...
typedef struct tagGsmModeInfo_s
{
	GsmComInfo sGsmComInfo;																	 
	uint16_t uiGsmUsartFlag;																 
	uint16_t uiGsmSingnelValue;															 
	uint16_t uiGsmSingnelBer;																 
	uint16_t uiGsmOpenOrCloseKeepTime;											 
	uint8_t GsmLoginStep;																		 
	uint16_t uiGsmRepetWaitTimes;														 
	uint16_t uiOperator;																		 
	uint16_t uiGsmTcpLinkState[5];							 
	uint16_t uiGsmTcpChanleEnableState[5];			 	
}GsmModeInfo; 


extern uint16_t SysGsmInit();
extern uint16_t GsmGpioControl(GPIO_TypeDef* GPIO,uint16_t GPIO_Pin,uint8_t State);
extern uint16_t GsmModeDel();
extern uint8_t SetGsmAteStr(uint8_t cmd);
extern uint8_t SetGsmAte(uint8_t cmd);
extern uint16_t GsmLoginDel();
extern uint16_t ReadGsmPIN();
extern GsmModeInfo mdGsm;
#line 2 "..\\User\\Gsm.c"
...
{
	uint16_t GPIO_Pin_txd;	 
	uint16_t GPIO_Pin_rxd;
	GPIO_TypeDef* GPIO_USART; 

	uint32_t USART_BaudRate;  	
	USARTCallFunc USARTUserDel;
}USARTInfo_s;
...
void USARTInit(USART_TypeDef* USARTx,uint32_t USART_BaudRate,GPIO_TypeDef* GPIO_USART,
					uint16_t GPIO_Pin_txd,uint16_t GPIO_Pin_rxd);
void USARTSendString(USART_TypeDef* USARTx,char *Message);
void USARTSendChar(USART_TypeDef* USARTx,char chars);
void USARTWrite(USART_TypeDef* USARTx,char *Buff,uint16_t sizes);
...
#line 5 "..\\User\\Gsm.c"
#line 1 "..\\BSP/SysDelay.h"



#line 5 "..\\BSP/SysDelay.h"
typedef struct tagSysTick_s
{
	uint32_t TimingDelay; 
}SysTick_s;
void SysDelayMs(volatile u32 nTime);
void SysTick_Init(uint32_t a);
void Delay_us(volatile u32 nTime);
extern SysTick_s mdSysTick;
#line 6 "..\\User\\Gsm.c"
#line 1 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 61 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"

#line 75 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 112 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 230 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 251 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"



extern const int math_errhandling;
#line 261 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 479 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 875 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"





#line 896 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"

#line 1087 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 1317 "e:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
uint8_t SendGsmControlCmd(char *Buff,uint16_t sizes)
{
	USARTWrite(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),Buff,sizes);
}
...
uint8_t CleanGsmRsp()
{
	...
	memset(&mdGsm.sGsmComInfo.RecvMessage[0],0,1024);
...
uint8_t GsmRspCheckOK()
{
	uint16_t uiLoop =0;
	
	for(uiLoop = 0;uiLoop < 1024; uiLoop++)
	{
			if((mdGsm.sGsmComInfo.RecvMessage[ uiLoop ]=='O')&&
					(mdGsm.sGsmComInfo.RecvMessage[ uiLoop + 1]=='K'))
			{
				return 1;											
			}
	}
...
uint8_t SetGsmAteStr(uint8_t cmd)
{
	memset(mdGsm.sGsmComInfo.SendMessage,0,512);
	 
	mdGsm.sGsmComInfo.SendMessage[0] = 'A';
	mdGsm.sGsmComInfo.SendMessage[1] = 'T';
	mdGsm.sGsmComInfo.SendMessage[2] = 'E';
	mdGsm.sGsmComInfo.SendMessage[3] = cmd + 0x30;
	mdGsm.sGsmComInfo.SendMessage[4] = '\r';
	mdGsm.sGsmComInfo.SendMessage[5] = '\n';
	mdGsm.sGsmComInfo.SendCount = 6;
}

 
uint8_t SetGsmAte(uint8_t cmd)
{
	 
	static uint8_t flage =0,CmdRepetTimes =0;
	if(!(mdGsm.uiGsmUsartFlag & 0X0080))
	{
		mdGsm.uiGsmUsartFlag |= 0X0080;
		if(flage == 0)
		{
			CleanGsmRsp();
			mdGsm.sGsmComInfo.RecvCount = 0; 
		}
		SetGsmAteStr(cmd); 
		
		SendGsmControlCmd((char *)mdGsm.sGsmComInfo.SendMessage,
											mdGsm.sGsmComInfo.SendCount);
		 
	}
	 
	
	if(mdGsm.sGsmComInfo.WorkFlage & 0X0040)
	{
		...
		if(GsmRspCheckOK())
		{
			...
			mdGsm.sGsmComInfo.WorkFlage &=~0X0040;
...
uint16_t GsmOpenDel()
{
	...
	if(!(mdGsm.uiGsmUsartFlag & 0X0010))
	{
		mdGsm.uiGsmOpenOrCloseKeepTime = 10;
		GsmGpioControl(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0100),1); 
		mdGsm.uiGsmUsartFlag |= 0X0100;
		mdGsm.uiGsmUsartFlag |= 0X0010; 
		mdGsm.uiGsmUsartFlag &= ~0X0020;
		 	
	}
	 
	if(!(mdGsm.uiGsmUsartFlag & 0X0020))
	{
		mdGsm.uiGsmOpenOrCloseKeepTime--;
		 
		if(mdGsm.uiGsmOpenOrCloseKeepTime == 0)
		{
			GsmGpioControl(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0100),0);
			mdGsm.uiGsmUsartFlag |= 0X0020;
			 
			mdGsm.sGsmComInfo.WorkFlage &= ~0X0040;
			 
			mdGsm.uiGsmOpenOrCloseKeepTime = 0;		
		}
	...
	if(mdGsm.uiGsmUsartFlag & 0X0100)
	{
		if(mdGsm.uiGsmOpenOrCloseKeepTime <= 5)
		{
			if(SetGsmAte(0))
			{
				mdGsm.uiGsmUsartFlag &=~0X0010;
...
uint16_t GsmConnectDel()
{
	if(!(mdGsm.uiGsmUsartFlag & 0X0002))
	{
		 
		 
		mdGsm.uiGsmSingnelValue = 0;
		 
		if(mdGsm.uiGsmUsartFlag & 0X0004)
		{
			
 
			if(mdGsm.uiGsmUsartFlag & 0X0008)
			{
				 
				mdGsm.uiGsmUsartFlag &=~0X0008; 
				return 1;
			}
			else
			{
		...
		else
		{
			...
			{
				LedOpen(LED1);
				mdGsm.uiGsmUsartFlag |= 0X0004; 
				mdGsm.uiGsmUsartFlag |= 0X0002; 
			}
		}
	}
...
uint8_t ReadGsmCGMRStr()
{
	memset(mdGsm.sGsmComInfo.SendMessage,0,512);
	mdGsm.sGsmComInfo.SendMessage[0] = 'A';
	mdGsm.sGsmComInfo.SendMessage[1] = 'T';
	mdGsm.sGsmComInfo.SendMessage[2] = '+';
	mdGsm.sGsmComInfo.SendMessage[3] = 'C';
	mdGsm.sGsmComInfo.SendMessage[4] = 'G';
	mdGsm.sGsmComInfo.SendMessage[5] = 'M';
	mdGsm.sGsmComInfo.SendMessage[6] = 'R';
	mdGsm.sGsmComInfo.SendMessage[7] = '\r';
	mdGsm.sGsmComInfo.SendMessage[8] = '\n';
	mdGsm.sGsmComInfo.SendCount = 9;
}
...
uint8_t ReadGsmCGMR()
{
	...
	if(!(mdGsm.uiGsmUsartFlag & 0X0080))
	{
		if(mdGsm.uiGsmRepetWaitTimes == 0)
		{
			mdGsm.uiGsmRepetWaitTimes = 10;
			mdGsm.uiGsmUsartFlag |= 0X0080;
			ReadGsmCGMRStr();
			mdGsm.sGsmComInfo.RecvCount = 0;
			CleanGsmRsp();	
		...
		if(mdGsm.sGsmComInfo.WorkFlage & 0X0040)
		{
			for(uiLoop = 0;uiLoop < 1024; uiLoop++)
			{
				if((mdGsm.sGsmComInfo.RecvMessage[uiLoop] == 'M') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop + 1]=='E') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop+2] == '3') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop + 3]=='0') &&
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop+4] == '0') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop + 5]=='0'))
				{
					...
					mdGsm.sGsmComInfo.RecvCount =0;
					mdGsm.uiGsmRepetWaitTimes = 0;
					return 1;
				}
				
				if((mdGsm.sGsmComInfo.RecvMessage[uiLoop] == 'M') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop + 1]=='G') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop+2] == '2') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop + 3]=='6') &&
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop+4] == '3') && 
					(mdGsm.sGsmComInfo.RecvMessage[uiLoop + 5]=='9'))
				{
...
uint8_t ReadGsmCGSNStr()
{
	...
	mdGsm.sGsmComInfo.SendMessage[3]='C';
	mdGsm.sGsmComInfo.SendMessage[4]='G';
	mdGsm.sGsmComInfo.SendMessage[5]='S';
	mdGsm.sGsmComInfo.SendMessage[6]='N';
	mdGsm.sGsmComInfo.SendMessage[7]='\r';
	mdGsm.sGsmComInfo.SendMessage[8]='\n';
	mdGsm.sGsmComInfo.SendCount =9;
}
...
uint16_t ReadSIMINSStr()
{
	memset(mdGsm.sGsmComInfo.SendMessage,0,512);
	mdGsm.sGsmComInfo.SendMessage[0]='A';
	mdGsm.sGsmComInfo.SendMessage[1]='T';
	mdGsm.sGsmComInfo.SendMessage[2]='*';
	mdGsm.sGsmComInfo.SendMessage[3]='T';
	mdGsm.sGsmComInfo.SendMessage[4]='S';
	mdGsm.sGsmComInfo.SendMessage[5]='I';
	mdGsm.sGsmComInfo.SendMessage[6]='M';
	mdGsm.sGsmComInfo.SendMessage[7]='I';
	mdGsm.sGsmComInfo.SendMessage[8]='N';
	mdGsm.sGsmComInfo.SendMessage[9]='S';
	mdGsm.sGsmComInfo.SendMessage[10]='?';
	mdGsm.sGsmComInfo.SendMessage[11]='\r';
	mdGsm.sGsmComInfo.SendMessage[12]='\n';
	
	mdGsm.sGsmComInfo.SendCount = 13;
}

 
uint16_t ReadSIMINS()
{
	uint16_t uiLoop =0,k =0;
	uint8_t flage =0;
	if(!(mdGsm.uiGsmUsartFlag & 0X0080))
	{
		if(mdGsm.uiGsmRepetWaitTimes == 0)
		...
		if(mdGsm.sGsmComInfo.WorkFlage & 0X0040)
		{
			for(uiLoop = 0;uiLoop < 1024;uiLoop++)
			{
					if((mdGsm.sGsmComInfo.RecvMessage[uiLoop]=='*')&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+1]=='T')&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+2]=='S')							&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+3]=='I')&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+4]=='M')&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+5]=='I') 						&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+6]=='N')&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+7]=='S')&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+8]==':'))


					{
						mdGsm.uiGsmRepetWaitTimes =0;
						if((mdGsm.sGsmComInfo.RecvMessage[uiLoop+12]>='0')&&(mdGsm.sGsmComInfo.RecvMessage[uiLoop+12]<='9'))
						{
							k=mdGsm.sGsmComInfo.RecvMessage[uiLoop+12]-0x30;
						}
						if(k>0)
						{
							{ if(1 == 1) { printf("SIM Card OK\r\n"); }};
							mdGsm.uiGsmUsartFlag &=~0X0080;
							mdGsm.sGsmComInfo.WorkFlage &=~0X0040;
							return 1;
						}
...
uint16_t ReadGsmPinStr()
{
	...
	mdGsm.sGsmComInfo.SendMessage[2]='+';
	mdGsm.sGsmComInfo.SendMessage[3]='C';
	mdGsm.sGsmComInfo.SendMessage[4]='P';
	mdGsm.sGsmComInfo.SendMessage[5]='I';
	mdGsm.sGsmComInfo.SendMessage[6]='N';
	mdGsm.sGsmComInfo.SendMessage[7]='?';
	mdGsm.sGsmComInfo.SendMessage[8]='\r';
	mdGsm.sGsmComInfo.SendMessage[9]='\n';
	mdGsm.sGsmComInfo.SendCount = 10;
}
...
uint16_t ReadGsmPIN()
{
	...
	if(!(mdGsm.uiGsmUsartFlag & 0X0080))
	{
		...
		if(mdGsm.sGsmComInfo.WorkFlage & 0X0040)
		{
			for(uiLoop = 0;uiLoop < 1024;uiLoop++)
			{
					if((mdGsm.sGsmComInfo.RecvMessage[uiLoop]=='R') && 
						(mdGsm.sGsmComInfo.RecvMessage[uiLoop+1]=='E') &&
						(mdGsm.sGsmComInfo.RecvMessage[uiLoop+2]=='A') &&
						(mdGsm.sGsmComInfo.RecvMessage[uiLoop+3]=='D') &&
						(mdGsm.sGsmComInfo.RecvMessage[uiLoop+4]=='Y'))
						{
							mdGsm.uiGsmRepetWaitTimes = 0;
							mdGsm.uiGsmUsartFlag &=~0X0080;	 
							mdGsm.sGsmComInfo.WorkFlage &=~0X0040; 
...
uint16_t ReadGsmCOPSStr()
{
	...
	mdGsm.sGsmComInfo.SendMessage[2]='+';
	mdGsm.sGsmComInfo.SendMessage[3]='C';
	mdGsm.sGsmComInfo.SendMessage[4]='O';
	mdGsm.sGsmComInfo.SendMessage[5]='P';
	mdGsm.sGsmComInfo.SendMessage[6]='S';
	mdGsm.sGsmComInfo.SendMessage[7]='=';
	mdGsm.sGsmComInfo.SendMessage[8]='3';
	mdGsm.sGsmComInfo.SendMessage[9]=',';
	mdGsm.sGsmComInfo.SendMessage[10]='2';
	mdGsm.sGsmComInfo.SendMessage[11]='\r';
	mdGsm.sGsmComInfo.SendMessage[12] ='\n';
...
uint16_t ReadGsmCSQStr()
{
	...
	mdGsm.sGsmComInfo.SendMessage[3]='C';
	mdGsm.sGsmComInfo.SendMessage[4]='S';
	mdGsm.sGsmComInfo.SendMessage[5]='Q';
	mdGsm.sGsmComInfo.SendMessage[6]='\r';
	mdGsm.sGsmComInfo.SendMessage[7]='\n';
	
	mdGsm.sGsmComInfo.SendCount = 8;
}
	...
	if(!(mdGsm.uiGsmUsartFlag & 0X0080))
	{
		...
		if(mdGsm.sGsmComInfo.WorkFlage & 0X0040)
		{
				if(GsmRspCheckOK())
				{
					for(uiLoop = 0;uiLoop < 1024;uiLoop++)
					{
							if((mdGsm.sGsmComInfo.RecvMessage[uiLoop]=='+') && 
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+1]=='C') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+2]=='S') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+3]=='Q') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+4]==':'))
								{
									uiKValue = 0;
									for(uiJoop = 6; uiJoop < 8;uiJoop++)
									{
										if((mdGsm.sGsmComInfo.RecvMessage[uiJoop +uiLoop]>='0') &&
											(mdGsm.sGsmComInfo.RecvMessage[uiJoop +uiLoop]<='9'))
										{
												uiTemp = mdGsm.sGsmComInfo.RecvMessage[uiJoop +uiLoop] - 0x30;
												uiTemp *= pow(10,(7 - uiJoop));
											  uiKValue += uiTemp;
										}
									}
									
									mdGsm.uiGsmSingnelValue = uiKValue;
									uiKValue = 0;
									for(uiJoop = 10; uiJoop < 12;uiJoop++)
									{
										if((mdGsm.sGsmComInfo.RecvMessage[uiJoop +uiLoop]>='0') &&
											(mdGsm.sGsmComInfo.RecvMessage[uiJoop +uiLoop]<='9'))
										{
												uiTemp = mdGsm.sGsmComInfo.RecvMessage[uiJoop +uiLoop] - 0x30;
												uiTemp *= pow(10,(11 - uiJoop));
											  uiKValue += uiTemp;
										}
									}
									mdGsm.uiGsmSingnelBer = uiKValue;
									
									if(1 == 1)
									{
										printf("Signel:%d  SignelBer:%d \n",mdGsm.uiGsmSingnelValue,
																											mdGsm.uiGsmSingnelBer);
									}
									mdGsm.uiGsmRepetWaitTimes = 0;
									mdGsm.uiGsmUsartFlag &=~0X0080;	 
									mdGsm.sGsmComInfo.WorkFlage &=~0X0040; 
...
uint16_t ReadGsmCOPSS()
{
	...
	if(!(mdGsm.uiGsmUsartFlag & 0X0080))
	{
		...
		if(mdGsm.sGsmComInfo.WorkFlage & 0X0040)
		{
				for(uiLoop = 0;uiLoop < 1024;uiLoop++)
				{
							if((mdGsm.sGsmComInfo.RecvMessage[uiLoop]=='4') && 
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+1]=='6') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+2]=='0') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+3]=='0') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+4]=='0'))
								{	
									 
									mdGsm.uiOperator = 46000;
									mdGsm.uiGsmRepetWaitTimes = 0;
									mdGsm.uiGsmUsartFlag &=~0X0080;	 
									mdGsm.sGsmComInfo.WorkFlage &=~0X0040; 
							...
							if((mdGsm.sGsmComInfo.RecvMessage[uiLoop]=='4') && 
								...
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+2]=='0') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+3]=='0') &&
								(mdGsm.sGsmComInfo.RecvMessage[uiLoop+4]=='1'))
								{	
									 
									mdGsm.uiOperator = 46001;
									mdGsm.uiGsmRepetWaitTimes = 0;
									mdGsm.uiGsmUsartFlag &=~0X0080;	 
									mdGsm.sGsmComInfo.WorkFlage &=~0X0040; 
...
uint16_t GsmLogin()
{
	switch(mdGsm.GsmLoginStep)
	{
		case 1:
			if(ReadGsmCGMR())
			{
				{ if(1 == 1) { printf("ReadGsmCGMR ok\r\n"); }};
				mdGsm.GsmLoginStep++;
			}
			break;
		case 2:
...
uint16_t GsmConnectServer()
{
	
}
 
uint16_t GsmConnetDel()
{
	 
	if(!(mdGsm.uiGsmTcpLinkState[0] & 0X0001))
	{
		 
		if(mdGsm.uiGsmTcpChanleEnableState[0] & 0X0002)
		{
			mdGsm.uiGsmTcpLinkState[0] |= 0X0001; 
			GsmConnectServer();
		}
	}
	return 0;
...
uint16_t GsmModeDel()
{
	...
	if(!(mdGsm.uiGsmUsartFlag & 0X0001))
	{
		 
		mdGsm.uiGsmUsartFlag |= 0X0001; 
		SysGsmInit(); 
		GsmGpioControl(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0100),0); 
		return 1;
	}
...
uint16_t GsmRecvCmdDel(uint16_t arg1,uint16_t arg2)
{
	mdGsm.sGsmComInfo.WorkFlage |= 0X02;	 
	
	mdGsm.sGsmComInfo.RecvMessage[mdGsm.sGsmComInfo.RecvCount] = arg1;
	
	mdGsm.sGsmComInfo.RecvCount++;
	
	if(mdGsm.sGsmComInfo.RecvCount > 2)
	{
		mdGsm.sGsmComInfo.WorkFlage |= 0X0040;
	}
	if(mdGsm.sGsmComInfo.RecvCount > 1024)
	{
...
uint16_t GsmPortInit()
{
	...
	GsmGpioControl(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),((uint16_t)0x0080),0);
	
}
uint16_t SysGsmInit()
{
	memset(&mdGsm,0,sizeof(GsmModeInfo));
	
	GsmParmInit();
	GsmPortInit();
	USARTInit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), 115200, ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0004), ((uint16_t)0x0008));
	
	mdUsart.USART2_s.USARTUserDel = GsmRecvCmdDel;
