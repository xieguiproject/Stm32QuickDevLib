...
void USARTGpioConfig(USARTInfo_s *UsartInfo)
{
	...
	GPIO_InitStructure.GPIO_Pin = UsartInfo->GPIO_Pin_rxd; 	
...
void USARTNvicConfig(uint8_t NVIC_IRQChannel,uint8_t MasterPro,uint8_t SlaPro)
{
	...
	NVIC_Config.NVIC_IRQChannel = NVIC_IRQChannel;  
	NVIC_Config.NVIC_IRQChannelPreemptionPriority= MasterPro;  
	NVIC_Config.NVIC_IRQChannelSubPriority = SlaPro; 
...
void USARTConfig(USART_TypeDef* USARTx,USARTInfo_s *UsartInfo)
{
	...
	USART_Init_Structure.USART_WordLength = ((uint16_t)0x0000);
	USART_Init_Structure.USART_StopBits = ((uint16_t)0x0000);	 
	USART_Init_Structure.USART_Parity = ((uint16_t)0x0000);	
	USART_Init_Structure.USART_HardwareFlowControl = ((uint16_t)0x0000);
	USART_Init_Structure.USART_Mode = ((uint16_t)0x0004) | ((uint16_t)0x0008);
	USART_ClockInitStructure.USART_Clock = ((uint16_t)0x0000);
	USART_ClockInitStructure.USART_CPOL = ((uint16_t)0x0000);
	USART_ClockInitStructure.USART_CPHA = ((uint16_t)0x0000);
	USART_ClockInitStructure.USART_LastBit = ((uint16_t)0x0100);

	USART_Init(USARTx,&USART_Init_Structure);
	USART_ClockInit(USARTx,&USART_ClockInitStructure);

	USART_Cmd(USARTx,ENABLE);
	USART_ClearFlag(USARTx,((uint16_t)0x0040));
	USART_ClearFlag(USARTx,((uint16_t)0x0525));
	USART_ClearITPendingBit(USARTx,((uint16_t)0x0626));
					...
					uint16_t GPIO_Pin_txd,uint16_t GPIO_Pin_rxd)
{
	...
	{
		case (uint32_t)((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)):
				{
					mdUsart.USART1_s.GPIO_Pin_rxd = GPIO_Pin_rxd;
					mdUsart.USART1_s.GPIO_Pin_txd = GPIO_Pin_txd;
					mdUsart.USART1_s.USART_BaudRate = USART_BaudRate;
					mdUsart.USART1_s.GPIO_USART = GPIO_USART;
					
					USARTGpioConfig(&mdUsart.USART1_s); 
					USARTNvicConfig(USART1_IRQn,7,0);
					USARTConfig(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),&mdUsart.USART1_s);
					break;
				}
		case (uint32_t)((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)):
				{
					mdUsart.USART2_s.GPIO_Pin_rxd = GPIO_Pin_rxd;
					mdUsart.USART2_s.GPIO_Pin_txd = GPIO_Pin_txd;
					mdUsart.USART2_s.USART_BaudRate = USART_BaudRate;
					mdUsart.USART2_s.GPIO_USART = GPIO_USART;
					
					USARTGpioConfig(&mdUsart.USART2_s); 
					USARTNvicConfig(USART2_IRQn,0,0);
					USARTConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),&mdUsart.USART2_s);
					break;
				}
	}
}
void USARTWrite(USART_TypeDef* USARTx,char *Buff,uint16_t sizes)
{
	...
	while(uiLoop < sizes)
	{
		USART_SendData(USARTx,(char)Buff[uiLoop]);
		while(USART_GetFlagStatus(USARTx,((uint16_t)0x0080))!=SET);
		uiLoop++;
	}
}
void USARTSendChar(USART_TypeDef* USARTx,char chars)
{
	switch((uint32_t)USARTx)
	{
		case (uint32_t)((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)):
				{
					USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),(uint16_t)chars);
					while(USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0080))!=SET);
					break;
				}
		case (uint32_t)((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)):
				{
					USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),(uint16_t)chars);
					while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),((uint16_t)0x0080))!=SET);
					break;
				}
	}
...
void USART1_IRQHandler(void)
{
	...
	if(USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0525)) != RESET)
	 { 
		...
		BackData = USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
		if(mdUsart.USART1_s.USARTUserDel != 0)
		{
...
void USART2_IRQHandler(void)
{
	...
	if(USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),((uint16_t)0x0525)) != RESET)
	 { 
		...
		BackData = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)));
		if(mdUsart.USART2_s.USARTUserDel != 0)
		{
			mdUsart.USART2_s.USARTUserDel(BackData,0); 
		}
	 } 
}
